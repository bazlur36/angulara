        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('tasks.update', $task->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('title')) has-error @endif">
                    ...
                    <input type="text" id="created_by-field" name="created_by" class="form-control" value="{{ $task->created_by }}"/>
                    ...
                    <textarea class="form-control" id="status-field" rows="3" name="status">{{ $task->status }}</textarea>
                    ...
                    <input type="text" id="deadline-field" name="deadline" class="form-control" value="{{ $task->deadline }}"/>
